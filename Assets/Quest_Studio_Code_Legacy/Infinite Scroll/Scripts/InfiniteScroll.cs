...
public class InfiniteScroll : MonoBehaviour, IBeginDragHandler, IDragHandler, IScrollHandler
{
    ...
    /// <summary>
    /// Scrolling Items Spacing Multiplier Value
    /// </summary>
    [SerializeField]
    private float scrollSpacingValue;
    ...
    private void HandleVerticalScroll()
    {
        ...
        if (positiveDrag)
        {
            newPos.y = endItem.position.y - scrollContent.ChildHeight * scrollSpacingValue + scrollContent.ItemSpacing;
        }
        else
        {
            newPos.y = endItem.position.y + scrollContent.ChildHeight * scrollSpacingValue - scrollContent.ItemSpacing;
    ...
    private void HandleHorizontalScroll()
    {
        ...
        if (positiveDrag)
        {
            newPos.x = endItem.position.x - scrollContent.ChildWidth * scrollSpacingValue + scrollContent.ItemSpacing;
        }
        else
        {
            newPos.x = endItem.position.x + scrollContent.ChildWidth * scrollSpacingValue - scrollContent.ItemSpacing;
